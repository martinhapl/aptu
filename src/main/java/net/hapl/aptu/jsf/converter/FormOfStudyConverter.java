...
@FacesConverter("net.hapl.aptu.jsf.converter.FormOfStudyConverter")
public class FormOfStudyConverter implements Converter {
   
    @Override
    public Object getAsObject(FacesContext fc, UIComponent uic, String s) {
        return Enums.FormOfStudy.valueOf(s); 
    }
