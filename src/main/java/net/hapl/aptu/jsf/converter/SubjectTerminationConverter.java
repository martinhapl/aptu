...
@FacesConverter("net.hapl.aptu.jsf.converter.SubjectTerminationConverter")
public class SubjectTerminationConverter implements Converter {
   
    @Override
    public Object getAsObject(FacesContext fc, UIComponent uic, String s) {
        return Enums.SubjectTermination.valueOf(s); 
    }
